...
export default function CommonCalculatorPage() {
    ...
    return (
        <>
            ...
            >
                <h1 className="font-h1Title text-white text-3xl text-center sm:text-5xl font-bold">Calculadora Comun</h1>

                <div
                    className="bg-gray-900 sm:w-[500px] grid grid-rows-6 grid-cols-4 gap-x-2 gap-y-4 p-5"
                >
                    <input
                        className="sm:min-w-[300px] p-2 bg-white text-black text-right col-span-4 text-3xl"
                        value={tela}
                        onChange={(e) => {
